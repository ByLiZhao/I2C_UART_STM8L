...
#define bit_write(b,n,value)        ((value)?((b)|=(0x01<<(n))):((b)&=~(0x01<<(n))))      
...
/* generic */
/* start critical section (see https://tenbaht.github.io/sduino/developer/sdcc/#notes-on-sdcc) */
#define critical_section_start()  ASM("sim")           
/* end critical section (see https://tenbaht.github.io/sduino/developer/sdcc/#notes-on-sdcc) */
#define critical_section_end()    ASM("rim")   
/* reset controller via WWGD module */
#define reset()             			WWDG_CR=0xBF    

/* Error check macro*/
#define check_error(e)						do{if((e)) return((e));}while(0)
